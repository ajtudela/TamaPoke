...
// temporizador mas largo son ~12s), sin cambiar como se guarda el deadline.
...
public:
  ...
  // uint16_t, no uint8_t: a uint8_t wraps back to 0 at ~10.6 days of play
  // (MINUTES_PER_LEVEL=60), which the game reaches in the ordinary course of
  // "stay together" postponing a farewell indefinitely. Capped, not wrapped.
